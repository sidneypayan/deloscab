...
})({"42n7V":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b197585022f1403d";
...
},{}],"iyOyE":[function(require,module,exports) {
...
function render() {
    ...
    let last = 3;
    const initAvis = ()=>{
        _avisJsonDefault.default.slice(first, last).forEach((item)=>{
            return avisBox.innerHTML += `<div class="home-avis__card ${item.current && 'home-avis__active'}">${item.commentaire}<img src="${item.img}" alt=""></div>`;
        });
    };
    btnRight.addEventListener('click', ()=>{
        if (last < _avisJsonDefault.default.length) {
            _avisJsonDefault.default[first + 2].current = true;
            _avisJsonDefault.default[first + 1].current = false;
            avisBox.innerHTML = '';
            first = first + 1;
            last = last + 1;
            initAvis(first, last);
    ...
    btnLeft.addEventListener('click', ()=>{
        if (first > 0) {
            _avisJsonDefault.default[first].current = true;
            _avisJsonDefault.default[first + 1].current = false;
            avisBox.innerHTML = '';
            first = first - 1;
            last = last - 1;
...
//# sourceMappingURL=avis.22f1403d.js.map

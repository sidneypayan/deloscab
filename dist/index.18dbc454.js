...
},{"./form":"l9hyy","./swiper":"rrgcw"}],"l9hyy":[function(require,module,exports) {
const formDevis = document.querySelector('#formDevis'), depart = document.querySelector('#depart'), arrivee = document.querySelector('#arrivee'), passagers = document.querySelector('#passagers'), date = document.querySelector('#date'), heure = document.querySelector('#heure'), nom = document.querySelector('#nom'), telephone = document.querySelector('#telephone'), email = document.querySelector('#email'), message = document.querySelector('#message'), error = document.querySelector('#error'), success = document.querySelector('#success');
const checkForm = (e)=>{
    // if (
    // 	!depart.value ||
    // 	!arrivee.value ||
...
},{"swiper":"cCbRx","../avis.json":"b9ku1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cCbRx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
